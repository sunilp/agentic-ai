...
![Illustration of a building cross-section with a calm thermostat in the central hallway while rooms behind the walls show very different conditions, including an overheated room with a red radiator and a frozen room with a leaking pipe](/agentic-ai/assets/illustrations/fn-002.png)
