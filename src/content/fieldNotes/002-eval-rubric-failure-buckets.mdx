---
id: fn-002
title: Your eval rubric needs failure buckets, not just scores
dek: Two agents can score identically on a benchmark and fail differently in production. The aggregate is not a rubric. It is what falls out of one.
...
primaryChapter: ch-06
banner: /agentic-ai/assets/banners/fn-002.png
date: 2026-05-17
readingTime: 7
pullQuote: An aggregate score is the average of the failure modes you did not catalog.
references: [ch-06]
patterns: [eval-loop, rubric-design]
sources:
  ...
  - title: "2026 AI Index Report -- Technical Performance"
    ...
    year: 2026
  - title: "State of AI Agents 2026: Lessons on Governance, Evaluation and Scale"
    url: https://lovelytics.com/post/state-of-ai-agents-2026-lessons-on-governance-evaluation-and-scale/
    authors: [Lovelytics]
    year: 2026
  - title: "5 Production Scaling Challenges for Agentic AI in 2026"
    url: https://machinelearningmastery.com/5-production-scaling-challenges-for-agentic-ai-in-2026/
    authors: [Machine Learning Mastery]
    year: 2026
---
...
![Two agents at 0.85 accuracy with different failure bucket distributions, showing why the aggregate hides what matters](/agentic-ai/assets/diagrams/eval-bucket-distribution.svg)

*Same aggregate. Different consequences. The agent on the right is unshippable, and the aggregate hides it.*
...
![Illustration of a building cross-section with a calm thermostat in the central hallway while rooms behind the walls show very different conditions, including an overheated room with a red radiator and a frozen room with a leaking pipe](/agentic-ai/assets/images/field-notes/002-illustration.png)

*The dial reads "average." Each room is failing in a different direction.*
...
<PullQuote>An aggregate score is the average of the failure modes you did not catalog.</PullQuote>

<Footer3Col
  fromBook={[
    { label: "Ch 6 — Evaluating and Hardening Agents", href: "/agentic-ai/book/06-evaluating-and-hardening/" },
  ]}
  inCode={[
    { label: "eval harness + rubric repo", href: "https://github.com/sunilp/agentic-ai/tree/main/code/eval" },
  ]}
