...
banner: /assets/banners/fn-002.png
spot: /assets/spots/fn-002.png
spotCaption: buckets of failure, not a single tidy score
date: 2026-05-17
readingTime: 7
...
![Two agents at 0.85 accuracy with different failure bucket distributions, showing why the aggregate hides what matters](/assets/diagrams/eval-bucket-distribution.svg)
...
![Illustration of a building cross-section with a calm thermostat in the central hallway while rooms behind the walls show very different conditions, including an overheated room with a red radiator and a frozen room with a leaking pipe](/assets/illustrations/fn-002.png)
