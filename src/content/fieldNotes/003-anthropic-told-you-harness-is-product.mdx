...
banner: /assets/banners/fn-003.png
spot: /assets/spots/fn-003.png
spotCaption: the harness does the work; the sphere just hangs there
date: 2026-05-26
readingTime: 8
...
![Harness anatomy: six components surrounding a model core](/assets/diagrams/harness-anatomy.svg)
...
<Footer3Col
  ...
  readNext={{ label: "FN-002 — Your eval rubric needs failure buckets", href: "/field-notes/002-eval-rubric-failure-buckets/" }}
/>
