...
banner: /assets/banners/fn-001.png
spot: /assets/spots/fn-001.png
spotCaption: the paper nobody cites is the one holding up the roof
date: 2026-05-14
readingTime: 8
...
![Illustration of a hall-of-mirrors corridor in which a small mark on an inspection card is amplified through repeated reflections](/assets/illustrations/fn-001.png)

*A small mark, re-cited as evidence by every reflection, becomes its own argument.*

![Diagram comparing error amplification in single-agent, hierarchical with verifier, and free-form coordination architectures](/assets/diagrams/multi-agent-error-amplification.svg)
...
<Footer3Col
  fromBook={[
    ...
    { label: "Ch 7 — When Not to Use Agents", href: "/book/07-when-not-to-use-agents/" },
  ]}
  inCode={[
