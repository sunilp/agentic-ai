...
<figure>
  <img src="/assets/diagrams/system-types-spectrum.svg" alt="Spectrum from LLM apps through workflows and tool-using systems to agents and multi-agent systems" />
