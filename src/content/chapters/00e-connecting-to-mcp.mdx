...
<figure>
  <img src="/agentic-ai/assets/diagrams/mcp-before-after.svg" alt="Before MCP: 5 apps times 4 tools equals 20 custom integrations. After MCP: 5 plus 4 equals 9 standard integrations." />
...
<figure>
  <img src="/agentic-ai/assets/diagrams/mcp-architecture.svg" alt="MCP architecture showing three roles: Host (your AI application with LLM and MCP client), MCP Servers (exposing tools), and two transport options (stdio for local, HTTP for remote)." />
...
<figure>
  <img src="/agentic-ai/assets/diagrams/mcp-lifecycle.svg" alt="MCP protocol lifecycle: 1) Initialize (handshake), 2) Discover (tools/list), 3) Invoke (tools/call), 4) Loop (result goes back to LLM for next decision)." />
