...
<figure>
  <img src="/agentic-ai/assets/diagrams/three-way-comparison.svg" alt="Three-way comparison showing raw agent, ADK, and LangChain across lines of code, debuggability, and production readiness" />
...
<figure>
  <img src="/agentic-ai/assets/diagrams/framework-decision-tree.svg" alt="Decision tree for choosing between raw agent, ADK, and LangChain based on team experience, production needs, and ecosystem requirements" />
...
<figure>
  <img src="/agentic-ai/assets/diagrams/framework-layers.svg" alt="Layered view showing tool logic at the bottom, framework in the middle, and eval on top, with the key insight that eval sits above all frameworks" />
