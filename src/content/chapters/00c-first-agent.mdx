...
<figure>
  <img src="/agentic-ai/assets/diagrams/agent-loop-foundations.svg" alt="The agent loop: observe, think, act, repeat until answer or budget exhaustion" />
...
<figure>
  <img src="/agentic-ai/assets/diagrams/agent-trace-waterfall.svg" alt="Waterfall trace of a multi-step agent run showing three model calls, two tool executions, and a final answer" />
...
<figure>
  <img src="/agentic-ai/assets/diagrams/three-failure-modes.svg" alt="Three failure modes: infinite loop (budget exhaustion), hallucinated tool (error recovery), confident wrong answer (silent failure)" />
...
<figure>
  <img src="/agentic-ai/assets/diagrams/before-after-guardrails.svg" alt="Before: raw loop with no protections. After: budget, validation, and logging added in 10 lines." />
...
For an expanded version with more tools, proper error handling, and example queries, see the [Research Agent](/agentic-ai/projects/research-agent/) project.
