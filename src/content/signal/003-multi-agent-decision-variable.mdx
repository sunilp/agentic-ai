...
banner: /assets/banners/sg-003.png
date: 2026-06-07
readingTime: 10
...
sources:
  ...
  - title: "Lab-001: Multi-agent vs router on 100 customer-support queries"
    url: https://agenticlab.sunilprakash.com/labs/multi-agent-vs-router-100-queries/
    authors: [Prakash S.]
    year: 2026
---
...
<ArchitectureDiagram
  src="/assets/diagrams/sg-003-decision.svg"
...
<Footer3Col
  fromBook={[
    { label: "Ch 3: Workflow First, Agent Second", href: "/book/03-workflow-first-agent-second/" },
    { label: "Ch 4: Multi-Agent Systems Without Theater", href: "/book/04-multi-agent-without-theater/" },
  ]}
  readNext={{ label: "Lab-001: the 100-query experiment behind this piece", href: "/labs/multi-agent-vs-router-100-queries/" }}
/>
