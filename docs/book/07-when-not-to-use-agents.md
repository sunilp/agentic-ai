...
- [Architecture Comparison](../proof/workflow-vs-agent-comparison.md) -- workflow vs agent metrics
- [Failure Case Studies](../proof/failure-cases.md) -- where agents failed and simpler approaches succeeded
